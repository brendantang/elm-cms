...
var $author$project$RequestStatus$Idle = {$: 'Idle'};
var $author$project$Main$IndexArticles = {$: 'IndexArticles'};
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$RequestStatus$Problem('Could not fetch articles from backend')
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GotArticleBody':
...
var $author$project$Main$ChangedSlug = function (a) {
	return {$: 'ChangedSlug', a: a};
};
var $author$project$Main$ChangedTitle = function (a) {
...
var $author$project$Main$viewMarkdown = function (string) {
	var _v0 = A2(
		$elm$core$Result$andThen,
		function (ast) {
...
var $author$project$Main$viewNotFound = {
	body: _List_fromArray(
		[
			$elm$html$Html$text('Route not found')
		]),
	title: 'Not found'
};
